...
mplementing an SDL program ensures that security is built into a software design rather than an afterthought.
...
Software security and the security development life cycle do not go away once software has been released. Prior to releasing any product, organizations must perform SDL activities that ensure that the product has met all regulatory and framework requirements, passed all vulnerability scans and penetration testing, and undergone all final security and privacy reviews. 

After the product ships to customers, organizations must have repeatable processes in place to communicate, identify, and mitigate threats before they affect customers.
